...
namespace GZipTest.Threading
{
        ...
        where T : class
    {
        ...
        private readonly int _memoryGateSizeInMb;
        ...
        /// <param name="memoryGateSizeInMb">The memory gate size. It's used to avoid an OutOfMemory exception.</param>
        ...
        public MultiThreadsWorker(
            ...
            int memoryGateSizeInMb)
            : this(workerCount, taskQueue, item => true, dequeueAction, memoryGateSizeInMb)
        {
        }
            ...
            int memoryGateSizeInMb)
        {
            ...
            _memoryGateSizeInMb = memoryGateSizeInMb;
                ...
                while (true)
                {
                    ...
                    if (isDequeued)
                    {
                        ...
                        while (inProgress)
                        {
                            try
                            {
                                using (new MemoryFailPoint(_memoryGateSizeInMb))
                                {
                                    _dequeueAction(item);
                                    inProgress = false;
                                }
